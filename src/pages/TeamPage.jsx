...
/**
 * The צוות (Team / Staff) page — recruitment funnel for people 20+ to join the
 * movement's staff. Mirrors the ליבה page architecture: a cinematic hero, warm-light
 * sections with the shared atmosphere, and navy accent bands for the מאמן centerpiece
 * and the closing CTA. `onContactOpen` opens the shared ContactModal; each section
 * passes a per-track tag (מאמן/ת / מדריך/ה בהזנק / צוות מטה).
 */
export default function TeamPage({ onContactOpen }) {
  ...
  return (
    <main>
      ...
      {/* No divider — the light intro sheet rises directly over the hero's dark base */}
      <TeamIntro />
