...
import CollabsWorldsV2 from '../redesign/collabs/CollabsWorldsV2'
import CollabsFormatsV2 from '../redesign/collabs/CollabsFormatsV2'
 ...
 * the three content worlds as the pinned signature, formats spec rows,
 * a quick four-step process, the מנכ״לית quote monument, and one door.
 *
...
export default function CollaborationsPage({ onContactOpen }) {
  ...
  return (
    <main>
      ...
      <CollabsTrustV2 />
      <CollabsWorldsV2 />
      <CollabsFormatsV2 onRegister={onRegister} />
      <CollabsProcessV2 />
      <CollabsQuoteV2 />
