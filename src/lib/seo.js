...
export const META = {
  home: {
    path: '/',
    title: 'חמש אצבעות — תנועה חינוכית-חברתית למצוינות ערכית',
    description:
      'מפתחים את הדור הבא של מנהיגי ישראל דרך מצוינות ערכית. תוכניות לגילאי 12–21+, כ-3,000 משתתפים ומשתתפות ברחבי ישראל.',
  },
  liabah: {
    path: '/liabah',
    title: 'קבוצות הנוער · גילאי 12–18' + SUFFIX,
    description:
