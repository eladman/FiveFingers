...
export const roster = {
  ...
  lead: 'בורד, הנהלה וצוות מטה, האנשים שעומדים מאחורי התנועה.',
  groups: [
    {
      id: 'board',
      title: 'בורד ומנכ״לים',
...
export const intro = {
  ...
  lead: 'יש כמה דרכים להוביל אצלנו, ולכל אחת מהן אנחנו מחפשים אנשים שרוצים להשפיע.',
  body:
...
export const hq = {
  ...
  lead:
    'חמש אצבעות היא גם צוות מטה שמניע את כל התנועה, ומחפש כל הזמן אנשים מוכשרים.',
  body:
