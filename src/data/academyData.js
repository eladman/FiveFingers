...
export const programs = [
  ...
  },
  {
    ...
    tab: 'Boost',
    title: 'Boost',
    subtitle: 'כחלק מתוכנית הזנק של צה״ל',
    ages: 'תוכנית קדם-צבאית · מסיימי/ות י״א ו-י״ב',
    contactTag: 'Boost',
    duration: 'מסיימי י״א - 3 שבועות בקיץ · מסיימי י״ב - 6 שבועות אחרי התיכון',
    focus: 'הכנה פיזית-מנטלית מרוכזת',
    forWhom: 'מסיימי/ות י״א ו-י״ב לקראת גיוס',
    description:
      'תוכנית קדם-צבאית חדשנית ויוקרתית, חלק מתוכנית הזנק של צה״ל: מסיימי/ות כיתה י״א ' +
      'בתוכנית מרוכזת בת שלושה שבועות בקיץ, ומסיימי/ות כיתה י״ב בתוכנית בת שישה שבועות אחרי התיכון. ' +
...
export const faq = [
  ...
  { id: 'f4', q: 'מה ההבדל בין המכינה ל-Boost?', a: 'המכינה היא שנת י״ג מלאה, ו-Boost היא תוכנית קדם-צבאית מרוכזת (חלק מתוכנית הזנק של צה״ל): מסיימי/ות י״א - שלושה שבועות בקיץ, ומסיימי/ות י״ב - שישה שבועות אחרי התיכון. שתיהן בנויות על שיטת חמש אצבעות.' }, // TODO
