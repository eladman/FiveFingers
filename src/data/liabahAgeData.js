...
export const agePages = {
  ...
  young: {
    ...
    overview: {
      heading: 'איך נראה אימון בקבוצה הצעירה?',
      lead:
        'היכרות ראשונה עם השיטה שלנו, בגובה העיניים של גיל היסודי: הרבה משחק ותנועה, אתגרים קטנים שנערמים להצלחות גדולות, וקבוצה שהופכת לבית.',
      training: [
    ...
    yearPlan: {
      heading: 'איך נראית שנה בקבוצה הצעירה?',
      ...
      items: [
        { month: 'ספטמבר', title: 'אימון פתיחה חגיגי', text: 'נפגשים, מכירים את הקבוצה והמאמן/ת ופותחים את השנה בגדול.', big: false }, // TODO
        { month: 'אוקטובר', title: 'גיבוש קבוצתי', text: 'משחקי צוות ואתגרים שהופכים אוסף ילדים לקבוצה.', big: false }, // TODO
        { month: 'נובמבר', title: 'חג המדדים הראשון', text: 'אימונים שבהם אנחנו בוחנים את התוצאות שלנו במדדי כושר שונים כדי להבין איפה אנחנו נמצאים.', big: true },
        { month: 'דצמבר', title: 'אתגר חנוכה', text: 'אימון מיוחד לחג — תחנות אור, משימות קבוצתיות והפתעות.', big: false }, // TODO
        { month: 'ינואר', title: 'יום תחרויות חורף', text: 'כל מתאמני/ות התנועה נפגשים/ות לשבוע שבו הקבוצות מתחרות אחת נגד השנייה באירוע יוצא דופן.', big: true },
        { month: 'פברואר', title: 'שבוע ערכים', text: 'שבוע שבו כל אימון מוקדש לערך אחד מחמשת ערכי התנועה.', big: false }, // TODO
        { month: 'מרץ', title: 'אימון משפחות', text: 'ההורים מוזמנים להתאמן יחד עם הילדים ולהרגיש את השיטה על עצמם.', big: false }, // TODO
        { month: 'אפריל', title: 'יום שטח ראשון', text: 'יוצאים מהמגרש אל הטבע — מסע קטן ראשון של הקבוצה.', big: false }, // TODO
        { month: 'מאי', title: 'חג המדדים השני', text: 'שבוע שבו אנחנו בוחנים שוב את היכולות הגופניות שלנו כדי לראות שיפור ואת התהליך שעשינו.', big: true },
        { month: 'יוני', title: 'יום תחרויות קיץ', text: 'יום שבו כל הקבוצות נפגשות ומתחרות אחת נגד השנייה.', big: true },
      ],
    },
    details: {
      heading: 'איפה מתאמנים?',
      lead: 'הקבוצות הצעירות פועלות בכל רחבי הארץ. מצאו את הקבוצה הקרובה אליכם.',
    },
    finale: {
      title: 'מתחילים את הצעד הראשון?',
      titleAccent: 'הצעד הראשון',
      subtitle: 'השאירו פרטים ונחבר אתכם/ן לקבוצה הצעירה הקרובה אליכם.',
      imageSrc: '/liba_pics/214A1343.jpg',
    },
    gallery: [
      { src: '/liba_pics/214A0052.jpg', alt: 'פעילות הקבוצות הצעירות' },
      { src: '/plans_pics/kids_liba.jpg', alt: 'פעילות הקבוצות הצעירות' },
      { src: '/liba_pics/214A0005.jpg', alt: 'פעילות הקבוצות הצעירות' },
    ],
  },
  ...
  middle: {
    ...
    yearPlan: {
      ...
      note: 'התוכנית להמחשה — האירועים והתאריכים המדויקים מתפרסמים בתחילת כל שנת פעילות.',
      items: [
        { month: 'ספטמבר', title: 'פתיחת שנה והצבת יעדים', text: 'כל מתאמן/ת מגדיר/ה יעד אישי לשנה — ומתחילים לעבוד.', big: false }, // TODO
        { month: 'נובמבר', title: 'חג המדדים הראשון', text: 'אימונים שבהם אנחנו בוחנים את התוצאות שלנו במדדי כושר שונים כדי להבין איפה אנחנו נמצאים.', big: true },
        ...
        { month: 'אפריל', title: 'מסע אביב', text: 'מסע השיא של השנה: יומיים של שטח, אתגר וגיבוש.', big: false }, // TODO
        { month: 'מאי', title: 'חג המדדים השני', text: 'שבוע שבו אנחנו בוחנים שוב את היכולות הגופניות שלנו כדי לראות שיפור ואת התהליך שעשינו.', big: true },
        { month: 'יוני', title: 'יום תחרויות קיץ', text: 'יום שבו כל הקבוצות נפגשות ומתחרות אחת נגד השנייה.', big: true },
      ],
    },
  ...
  high: {
    ...
    yearPlan: {
      ...
      note: 'התוכנית להמחשה — האירועים והתאריכים המדויקים מתפרסמים בתחילת כל שנת פעילות.',
      items: [
        { month: 'ספטמבר', title: 'פתיחת שנה ויעדים אישיים', text: 'מגדירים יעדים לשנה — כושר, תפקיד והשפעה — ובונים תוכנית אישית.', big: false }, // TODO
        { month: 'אוקטובר', title: 'מסע ניווטים', text: 'ניווט לילה קבוצתי: מפה, לחץ זמן והחלטות בשטח.', big: false }, // TODO
        { month: 'נובמבר', title: 'חג המדדים הראשון', text: 'אימונים שבהם אנחנו בוחנים את התוצאות שלנו במדדי כושר שונים כדי להבין איפה אנחנו נמצאים.', big: true },
        { month: 'דצמבר', title: 'שבוע מנהיגות', text: 'המתאמנים/ות מתכננים ומובילים את האימונים בעצמם.', big: false }, // TODO
        { month: 'ינואר', title: 'יום תחרויות חורף', text: 'כל מתאמני/ות התנועה נפגשים/ות לשבוע שבו הקבוצות מתחרות אחת נגד השנייה באירוע יוצא דופן.', big: true },
        { month: 'מרץ', title: 'מסע אביב — המסע הגדול', text: 'שיא השנה: מסע רב-יומי שמזקק את כל מה שנבנה.', big: false }, // TODO
        { month: 'מאי', title: 'חג המדדים השני', text: 'שבוע שבו אנחנו בוחנים שוב את היכולות הגופניות שלנו כדי לראות שיפור ואת התהליך שעשינו.', big: true },
        { month: 'יוני', title: 'יום תחרויות קיץ', text: 'יום שבו כל הקבוצות נפגשות ומתחרות אחת נגד השנייה.', big: true },
      ],
    },
