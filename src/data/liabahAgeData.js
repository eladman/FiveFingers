  ...
  young: {
    ...
    yearPlan: {
      ...
      items: [
        ...
        { month: 'נובמבר', title: 'חג המדדים הראשון', text: 'אימונים שבהם אנחנו בוחנים את התוצאות שלנו במדדי כושר שונים כדי להבין איפה אנחנו נמצאים.', big: false },
        ...
        { month: 'מאי', title: 'חג המדדים השני', text: 'שבוע שבו אנחנו בוחנים שוב את היכולות הגופניות שלנו כדי לראות שיפור ואת התהליך שעשינו.', big: false },
