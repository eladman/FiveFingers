...
//  · 2014 · עמיר ויורם מנחם · "מיזם מקומי → תנועה ארצית" · ~3,000 חניכים/ות
...
//
// Deliberately NOT claimed, because no source supports it: that Amir and Yoram
// are brothers (they share a surname and are only ever listed as co-founders),
...
export const HERO_META = ['נוסדה 2014', 'עמיר ויורם מנחם', 'כ-3,000 חניכים וחניכות']

/** The opening paragraph, set larger than the body — the story's way in. */
export const LEAD =
  'בשנת 2014 יצאו עמיר ויורם מנחם לדרך עם טענה אחת, פשוטה ועקשנית: אפשר לחנך אחרת. ' +
  'לא עוד חוג ולא עוד שיעור — מסגרת שמאמנת אופי.'
...
export const STORY = [
  {
    ...
    label: 'ההתחלה',
    paras: [
      'הם רצו לאתגר את המציאות החינוכית הקיימת ולחנך דור חדש על בסיס תפיסת עולם של ' +
  ...
  },
  {
    ...
    label: 'ההרחבה',
    paras: [
      'בספטמבר 2018 נפתחה אקדמיית חמש אצבעות, מכינה קדם-צבאית לשנת י״ג. הליווי כבר ' +
  ...
  },
  {
    ...
    paras: [
      'ממיזם מקומי לתנועה ארצית של כ-3,000 חניכים וחניכות. התנועה פועלת כצי של ספינות ' +
        'שמכסה את כל הדרך: הליבה (12–18), האקדמיה (18–20), ארגון הבוגרים ותוכנית יואב ' +
