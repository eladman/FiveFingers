...
const PROGRAMS = [
  {
    ...
    badge: 'גילאי 10–18',
    description:
      'מיועדת לבני ובנות נוער מכיתה ה׳ עד י״ב. תכנית הבסיס של התנועה המהווה את יסודות השיטה הפיזית מנטלית. התכנית בונה ומעצבת היבטי חוסן, הרגלים, יכולות עבודה בצוות וכלים למנהיגות רבים בקרב בני ובנות נוער.',
