            ...
            return (
              <div
                ...
                className={`fq-animate rounded-xl border overflow-hidden transition-all duration-300 ${
                  isOpen
                    ? 'border-[#ff8714]/60 bg-[#ff8714]/[0.035] shadow-sm'
                    : 'border-[#000032]/10 bg-white hover:border-[#ff8714]/30'
                }`}
              >
                <button
                  onClick={() => setOpen(isOpen ? null : item.id)}
                  aria-expanded={isOpen}
                  className="w-full flex items-center justify-between gap-4 text-right px-6 py-5 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff8714] focus-visible:ring-inset"
                >
