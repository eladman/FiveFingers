 ...
 */
export default function TeamFinaleV2({ onRegister }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <img
          src="/team_hero/_14A9373.jpg"
          alt=""
          aria-hidden="true"
          loading="lazy"
          decoding="async"
          className="tf-photo absolute inset-0 w-full h-full object-cover will-change-transform"
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-10 text-center py-28">
        <h2
          className="tf-el font-ragmarom text-white leading-[1.0]"
          style={{ fontSize: 'clamp(2.8rem, 7vw, 7rem)', textShadow: '0 4px 32px rgba(0,0,0,0.9)', textWrap: 'balance' }}
        >
          רוצים להיות חלק <span className="text-orange">מהצוות?</span>
        </h2>
        <p
          className="tf-el font-heebo text-white/80 mt-6 max-w-xl mx-auto leading-relaxed"
          style={{ fontSize: 'clamp(1.05rem, 1.4vw, 1.3rem)', textShadow: '0 2px 16px rgba(0,0,0,0.8)' }}
        >
          {cta.lead}
        </p>

        <div className="tf-el mt-11 flex flex-wrap items-center justify-center gap-5">
        ...
        <div
          className="tf-el mt-14 pt-6 border-t border-white/15 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 font-heebo text-sm md:text-base"
