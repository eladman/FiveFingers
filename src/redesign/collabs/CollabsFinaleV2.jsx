  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-10 text-center py-28">
        ...
        >
          <a href={`tel:${PHONE.replace(/-/g, '')}`} dir="ltr" className="text-white/60 hover:text-white transition-colors">
            {PHONE}
          </a>
          <span className="w-1 h-1 rounded-full bg-orange inline-block" aria-hidden="true" />
          <a href={`mailto:${EMAIL}`} dir="ltr" className="text-white/60 hover:text-white transition-colors">
            {EMAIL}
          </a>
        </div>
      </div>
